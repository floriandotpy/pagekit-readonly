        ...
        <!-- Header -->
            <section id="header">
                <header>
                    ...
                    <p>Place widgets in the <strong>sidebar-top</strong> position to replace this content.</p>
                    <?php endif; ?>
                </header>
                    ...
                    <section id="footer">
                        <div class="container">
                             <?php if ($view->menu()->exists('footer')) : ?>
                                <?= $view->position('footer', 'plain') ?>
                            <?php else: ?>
                            <ul class="copyright">
                                <li>&copy; Untitled. All rights reserved.</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li><li>Place widgets in the <strong>footer</strong> position to replace this content.</li>
                            </ul>
                            <?php endif; ?>
                        </div>
                    </section>
